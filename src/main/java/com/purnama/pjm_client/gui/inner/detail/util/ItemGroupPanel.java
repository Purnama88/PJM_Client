...
public class ItemGroupPanel extends MyPanel{
    ...
    private final ItemItemGroupTableModel2 itemitemgrouptablemodel;
    ...
    public ItemGroupPanel(int itemid){
        super(new BorderLayout());
        
        table = new MyTable();
        scrollpane = new MyScrollPane();
        
        itemitemgrouptablemodel = new ItemItemGroupTableModel2();
    ...
    public void load(){
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("itemitemgroups?itemid=" + itemid);
