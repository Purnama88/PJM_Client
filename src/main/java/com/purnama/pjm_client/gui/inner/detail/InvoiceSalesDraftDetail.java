...
public class InvoiceSalesDraftDetail extends InvoiceDraftDetailPanel{
    ...
    public InvoiceSalesDraftDetail(int invoiceid){
        ...
        numberingpanel = new NumberingComboBoxPanel(Menu.MENU_INVOICESALES);
    ...
    protected void close() {
        SwingWorker<Boolean, String> saveworker = new SwingWorker<Boolean, String>(){
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.post("invoicesales/" + invoicesalesdraft.getId(), "");
            ...
            protected void done() {
                ...
                if(response == null){
                    ...
                    GlobalFields.MAINTABBEDPANE.changeTabPanel(getIndex(), new InvoiceSalesDetail(Integer.parseInt(output)));
                }
            }
        };
        saveworker.execute();
    ...
    public void refresh(){
        ...
        load();
        iteminvoicesalesdrafttablepanel.refresh();
    }
