...
public class ExpensesDraftDetail extends InvoiceDraftDetailPanel{
    ...
    public ExpensesDraftDetail(int invoiceid){
        ...
        numberingpanel = new NumberingComboBoxPanel(Menu.MENU_EXPENSES);
    ...
    private void init(){
        iteminvoicedialog.setTablemodel(itemexpensesdrafttablepanel.getItemexpensesdrafttablemodel());
    ...
    @Override
    protected void home() {
        GlobalFields.MAINTABBEDPANE.changeTabPanel(getIndex(), new ExpensesDraftHome());
    }
    ...
    protected void close() {
        SwingWorker<Boolean, String> saveworker = new SwingWorker<Boolean, String>(){
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.post("expenses/" + expensesdraft.getId(), "");
            ...
            protected void done() {
                ...
                if(response == null){
                    ...
                    GlobalFields.MAINTABBEDPANE.changeTabPanel(getIndex(), new ExpensesDetail(Integer.parseInt(output)));
                }
            }
        };
        saveworker.execute();
    ...
    public void refresh(){
        ...
        itemexpensesdrafttablepanel.refresh();
        load();
    }
    ...
    protected void delete() {
        SwingWorker<Boolean, String> saveworker = new SwingWorker<Boolean, String>(){
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.delete("expensesdrafts/" + expensesdraft.getId(), "");
