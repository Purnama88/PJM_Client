...
public class ReturnSalesHome extends HomePanel{
    ...
    public ReturnSalesHome() {
        super(GlobalFields.PROPERTIES.getProperty("PANEL_RETURNSALES_HOME"));
         
        returnsalestablemodel = new ReturnSalesTableModel();
    ...
    protected void load() {
        ...
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("returnsales?itemperpage=" + itemperpage + "&page=" + page +
                        "&keyword=" + keyword);
    ...
    protected void detail() {
        ReturnSales returnsales = returnsalestablemodel.getReturnSales(table.
                    convertRowIndexToModel(table.getSelectedRow()));
        
        GlobalFields.MAINTABBEDPANE.insertTab(getIndex()+1, new ReturnSalesDetail(returnsales.getId()));
    }
