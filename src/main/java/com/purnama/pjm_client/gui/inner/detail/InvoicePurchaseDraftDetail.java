...
public class InvoicePurchaseDraftDetail extends InvoiceDraftDetailPanel{
    ...
    public InvoicePurchaseDraftDetail(int invoiceid){
        ...
        numberingpanel = new NumberingComboBoxPanel(Menu.MENU_INVOICEPURCHASE);
    ...
    protected void close() {
        SwingWorker<Boolean, String> saveworker = new SwingWorker<Boolean, String>(){
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.post("invoicepurchases/" + invoicepurchasedraft.getId(), "");
            ...
            protected void done() {
                ...
                if(response == null){
                    ...
                    GlobalFields.MAINTABBEDPANE.changeTabPanel(getIndex(), new InvoicePurchaseDetail(Integer.parseInt(output)));
                }
            }
        };
        saveworker.execute();
    ...
    public void refresh(){
        ...
        load();
        iteminvoicepurchasedrafttablepanel.refresh();
    }
