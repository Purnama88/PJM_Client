 ...
 * @author p_cor
 */
public class BrandDetail extends DetailPanel{
    ...
    public BrandDetail(int id) {
        super(GlobalFields.PROPERTIES.getProperty("PANEL_BRAND_DETAIL"));
    ...
    protected void home() {
        ...
        tabbedPane.changeTabPanel(getIndex(), new BrandHome());
    }
