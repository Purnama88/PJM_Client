...
public class ItemEdit extends ItemAdd{
    ...
    private void init(){
        setName(GlobalFields.PROPERTIES.getProperty("PANEL_ITEM_EDIT"));
            ...
            protected void done() {
                ...
                if(response == null){
                    ...
                    try{
                        ...
                        descriptionpanel.setTextAreaValue(item.getDescription());
                        costpanel.setTextFieldValue(item.getCost());
                        labelpanel.setComboBoxValue(item.getLabel());
