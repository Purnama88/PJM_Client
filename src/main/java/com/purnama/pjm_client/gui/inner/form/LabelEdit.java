 ...
 * @author p_cor
 */
public class LabelEdit extends LabelAdd{
    
    private final int id;
    
    public LabelEdit(int id){
        this.id = id;
    ...
    private void init(){
        setName(GlobalFields.PROPERTIES.getProperty("PANEL_LABEL_EDIT"));
    ...
    public final void load(){
        SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
                ...
                response = RestClient.get("labels/" + id);
            ...
            protected void done() {
                ...
                if(response == null){
                    ...
                    try{
                        label = mapper.readValue(output, Label.class);
                        
                        codepanel.setTextFieldEditable(false);
                        
                        codepanel.setTextFieldValue(label.getCode());
                        namepanel.setTextFieldValue(label.getName());
                        descriptionpanel.setTextAreaValue(label.getDescription());
        ...
        if(validateinput()){
            SwingWorker<Boolean, String> worker = new SwingWorker<Boolean, String>() {
                ...
                protected Boolean doInBackground(){
                    ...
                    clientresponse = RestClient.put("labels", label);
