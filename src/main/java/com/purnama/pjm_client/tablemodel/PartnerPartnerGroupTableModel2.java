 ...
 * @author p_cor
 */
public class PartnerPartnerGroupTableModel2 extends AbstractTableModel{
    ...
    public PartnerPartnerGroupTableModel2(){
        super();
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        Object[] values = new Object[]{
            partnerpartnergroup.getPartnergroup().getCode(), 
            partnerpartnergroup.getPartnergroup().getName(),
            partnerpartnergroup.getPartnergroup().isStatus()
        };
